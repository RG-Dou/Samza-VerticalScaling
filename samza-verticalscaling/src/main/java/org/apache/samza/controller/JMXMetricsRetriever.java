...
//                                LOG.info("Topic: " + topic + ", Partition ID: " + partitionId + ", Lag Messages: " + ok);
...
//        LOG.info("Memory, " + sb);
        ...
        metrics.put("ExecutorArrived", executorArrived);
        metrics.put("ExecutorProcessed", executorProcessed);
