...
import org.apache.samza.job.model.*;
...
public class ResourceModelMapper {
    ...
    public static ObjectMapper getObjectMapper() {
        ...
        SimpleModule module = new SimpleModule("SamzaResourceModule", new Version(1, 0, 0, ""));
        ...
        mapper.getSerializationConfig().addMixInAnnotations(ResourceModel.class, JsonResourceModelMixIn.class);
        mapper.getDeserializationConfig().addMixInAnnotations(ResourceModel.class, JsonResourceModelMixIn.class);
        mapper.getSerializationConfig().addMixInAnnotations(ResponseModel.class, JsonResponseModelMixIn.class);
        mapper.getDeserializationConfig().addMixInAnnotations(ResponseModel.class, JsonResponseModelMixIn.class);
